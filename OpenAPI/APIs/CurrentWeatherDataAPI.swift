...
open class CurrentWeatherDataAPI {
     ...
     */
    open class func currentWeatherData(q: String? = nil, id: String? = nil, lat: String? = nil, lon: String? = nil, zip: String? = nil, units: Units_currentWeatherData? = nil, lang: Lang_currentWeatherData? = nil, mode: Mode_currentWeatherData? = nil, appKey: String, completion: @escaping ((_ data: WeatherModel200?,_ error: Error?) -> Void)) {
        
        currentWeatherDataWithRequestBuilder(q: q, id: id, lat: lat, lon: lon, zip: zip, units: units, lang: lang, mode: mode, appKey: appKey).execute { (response, error) -> Void in
     ...
     */
    open class func currentWeatherDataWithRequestBuilder(q: String? = nil, id: String? = nil, lat: String? = nil, lon: String? = nil, zip: String? = nil, units: Units_currentWeatherData? = nil, lang: Lang_currentWeatherData? = nil, mode: Mode_currentWeatherData? = nil, appKey: String) -> RequestBuilder<WeatherModel200> {
        let path = "/weather"
        ...
        let requestBuilder: RequestBuilder<WeatherModel200>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
